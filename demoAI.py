...
def working(query):     #user input will be compare by each task
    ...
    if "time" in query:  # Test Status : Working
        ...
        readFile = open(
            file=r"C:\Users\zsev6\Documents\Completed Projects\FLASK\Voice Assistant Flask Framework\Source Code\static\read.txt",
            mode="r+",
        )
        ...
        openFile = open(
            file=r"C:\Users\1Crore Projects\Downloads\Voice-Assistant-Flask-main\Voice-Assistant-Flask-main\static/read.txt",
            mode="a",
        )
